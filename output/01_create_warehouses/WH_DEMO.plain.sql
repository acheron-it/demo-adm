...
USE    ROLE                     IDENTIFIER('SYSADMIN');
  CREATE WAREHOUSE IF NOT EXISTS  IDENTIFIER('WH_DWH_T_DEMO') WITH WAREHOUSE_SIZE = 'XSMALL';
  ALTER WAREHOUSE IDENTIFIER('WH_DWH_T_DEMO') SET WAREHOUSE_TYPE = 'STANDARD';
 ...
 **/
USE    ROLE                     IDENTIFIER('SYSADMIN');
  CREATE WAREHOUSE IF NOT EXISTS  IDENTIFIER('WH_DWH_A_DEMO') WITH WAREHOUSE_SIZE = 'XSMALL';
  ALTER WAREHOUSE IDENTIFIER('WH_DWH_A_DEMO') SET WAREHOUSE_TYPE = 'STANDARD';
